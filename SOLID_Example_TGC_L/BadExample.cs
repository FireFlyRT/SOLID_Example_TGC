...
namespace SOLID_Example_TGC_L_Bad
{
    public class BattleField
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Das Verhalten wird "unvorhersehbar"
    ...
    public class InstantSpellCard : SpellCard
    {
        ...
        public override void PlayCard(Card[] cardFields)
        {
            // Die Funktion der Basis-Klasse wird nicht aufgerufen.
            // Deshalb wird die Karte nicht in dem array gespeichert.
            // Die Kind-Klasse weicht von der Funktion der Eltern-Klasse ab!
